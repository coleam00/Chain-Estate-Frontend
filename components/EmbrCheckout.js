...
export default function EmbrCheckout(props) {
    useEffect(() => {
    ...
    return (
        <Grid container justifyContent="center" spacing={5} className={clsx(styles.embrGrid, styles.airdropGridBackground, props.useDarkTheme ? styles.airdropGridShadowDark : styles.airdropGridShadowLight)}>
